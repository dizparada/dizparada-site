...
import { S as d, t as f } from "./motion.CLjJX74m.mjs";
import { A as p, C as m, St as h, Y as g, k as _, s as v } from "./framer.BQfDiYYl.mjs";
import { a as ee, n as y, t as b } from "./default-utils.js__0.45.BIBXjq3o.mjs";
function x(e, t) {
...
function E() {
  ...
  if (ne(r)) return `https://vimeo.com/${r}`;
  if (T(r)) return r.replace(`http:`, `https:`);
  throw t
...
function k(e, t, n) {
  ...
  var i = r[t].indexOf(n);
  return (i !== -1 && r[t].splice(i, 1), W.set(e.element, r), r[t] && r[t].length === 0);
}
function A(e, t) {
  var n = O(e, t);
...
function P(e) {
  ...
  return new Promise(function (r, i) {
    if (!T(e)) throw TypeError(`“${e}” is not a vimeo.com url.`);
    var a = `https://vimeo.com/api/oembed.json?url=${encodeURIComponent(e)}`;
    for (var o in t) t.hasOwnProperty(o) && (a += `&${o}=${encodeURIComponent(t[o])}`);
    var s = `XDomainRequest` in u ? new XDomainRequest() : new XMLHttpRequest();
    (s.open(`GET`, a, !0),
      (s.onload = function () {
        if (s.status !== 404)
          if (s.status !== 403)
            try {
              ...
              if (t.domain_status_code === 403) {
                (N(t, n), i(Error(`“${e}” is not embeddable.`)));
                return;
              }
              r(t);
            } catch (e) {
      ...
      (s.onerror = function () {
        ...
        i(Error(`There was an error fetching the embed code from Vimeo${e}.`));
      }),
      s.send());
  });
}
...
function I() {
  ...
  u.VimeoPlayerResizeEmbeds_ ||
    ((u.VimeoPlayerResizeEmbeds_ = !0),
    u.addEventListener(`message`, function (t) {
      if (T(t.origin) && t.data && t.data.event === `spacechange`) {
...
function R(e, t, n) {
  if (e.element.contentWindow && e.element.contentWindow.postMessage) {
    var r = { method: t };
    n !== void 0 && (r.value = n);
    var i = parseFloat(s.userAgent.toLowerCase().replace(/^.*msie (\d+).*$/, `$1`));
...
function ie(e, t) {
  ...
  if (t.event)
    (t.event === `error` &&
      O(e, t.data.method).forEach(function (n) {
    ...
    n = {
      request: function (t) {
        return new Promise(function (r, i) {
          ...
          (n.on(`fullscreenchange`, a), (t ||= document.documentElement));
...
var z,
  ...
  oe = e(() => {
    if (
      (i(),
      (z = r !== void 0 && {}.toString.call(r) === `[object global]`),
      (B = Array.prototype.indexOf !== void 0),
      (V = u !== void 0 && u.postMessage !== void 0),
      !z && (!B || !V))
    )
    ...
    ((H =
        ...
        if (!e.WeakMap) {
          ...
          e.WeakMap = (function () {
            function e() {
              ...
              if ((n(this, `_id`, a(`_WeakMap`)), arguments.length > 0))
            ...
            (n(e.prototype, `delete`, function (e) {
              ...
              n(e.prototype, `set`, function (e, t) {
                if ((i(this, `set`), !r(e))) throw TypeError(`Invalid value used as weak map key`);
                var a = e[this._id];
                return a && a[0] === e ? ((a[1] = t), this) : (n(e, this._id, [e, t]), this);
              }));
            function i(e, n) {
              if (!r(e) || !t.call(e, `_id`))
                throw TypeError(n + ` method called on incompatible receiver ` + typeof e);
            }
            function a(e) {
              return e + `_` + o() + `.` + o();
            }
      ...
      })(typeof self < `u` ? self : u === void 0 ? H : u),
      (U = re(function (e) {
        (function (t, n, r) {
          ...
          n = (function () {
            ...
            return {
              add: function (t, a) {
                ((r = new i(t, a)), n ? (n.next = r) : (e = r), (n = r), (r = void 0));
              },
              drain: function () {
                var r = e;
            ...
            if (!n.triggered) {
              ...
              try {
                (t = o(e))
                  ...
                  : ((n.msg = e), (n.state = 1), n.chain.length > 0 && a(s, n));
              } catch (e) {
                u.call(new f(n), e);
              }
            }
        ...
        function e(t) {
          ...
          if (
            ...
            u.jQuery &&
              ...
              (t = t[0])),
            typeof document < `u` && typeof t == `string` && (t = document.getElementById(t)),
            !te(t))
          )
            throw TypeError(`You must pass either a valid element or a valid id.`);
          if (t.nodeName !== `IFRAME`) {
            var i = t.querySelector(`iframe`);
            i && (t = i);
          }
          if (t.nodeName === `IFRAME` && !T(t.getAttribute(`src`) || ``))
          ...
          var a = new U(function (e, i) {
            if (
              ((n._onMessage = function (t) {
                if (T(t.origin) && n.element.contentWindow === t.source) {
                  n.origin === `*` && (n.origin = t.origin);
                  var r = L(t.data);
                  if (r && r.event === `error` && r.data && r.data.method === `ready`) {
                    var a = Error(r.data.message);
                    ((a.name = r.data.name), i(a));
                  } else {
                    var o = r && r.event === `ready`,
                      s = r && r.method === `ping`;
                    o || s ? (n.element.setAttribute(`data-ready`, `true`), e()) : ie(n, r);
                  }
                }
              }),
          ...
          if (
            ...
            this.element.nodeName === `IFRAME` && R(this, `ping`),
            J.isEnabled)
          ) {
            var o = function () {
              return J.exit();
            ...
            ((this.fullscreenchangeHandler = function () {
              (J.isFullscreen ? D(n, `event:exitFullscreen`, o) : k(n, `event:exitFullscreen`, o),
                n.ready().then(function () {
                  R(n, `fullscreenchange`, J.isFullscreen);
                }));
            }),
          ...
          C(e, [
              ...
              value: function (e) {
                ...
                return new U(function (r, i) {
                  return t
                    .ready()
                    .then(function () {
                      (D(t, e, { resolve: r, reject: i }), R(t, e, n));
                    })
                    .catch(i);
                });
              },
                ...
                return new U(function (n, r) {
                  return (
                    ...
                    t
                      .ready()
                      .then(function () {
                        (D(t, e, { resolve: n, reject: r }), R(t, e));
                      })
                      .catch(r)
                  );
                });
              ...
              value: function (e, t) {
                ...
                return new U(function (r, i) {
                  ...
                  return n
                    .ready()
                    .then(function () {
                      (D(n, e, { resolve: r, reject: i }), R(n, e, t));
                    })
                    .catch(i);
                });
              },
            },
            {
              ...
              value: function (e, t) {
                ...
                if (typeof t != `function`) throw TypeError(`The callback must be a function.`);
                (O(this, `event:${e}`).length === 0 &&
            ...
            },
            {
              key: `getFullscreen`,
              value: function () {
                return J.isEnabled ? U.resolve(J.isFullscreen) : this.get(`fullscreen`);
              },
            },
            {
              ...
              value: function () {
                ...
                return new U(function (t) {
                  ...
                  (e._window.removeEventListener(`message`, e._onMessage),
                    J.isEnabled && J.off(`fullscreenchange`, e.fullscreenchangeHandler),
                    t());
                });
              },
            },
...
e(() => {
  (l(),
    ...
    (Z = h(
      function ({
        ...
        return (
          a(() => {
            if (!b.current) return;
            let [, n] = e.match(X) ? e.match(X) : [null, 0],
              a = new Y(b.current, {
                id: n,
                autopause: !1,
                autoplay: m.current() === m.canvas ? !1 : t,
                byline: l,
                controls: i,
                loop: s,
                title: l,
          ...
          c(d.div, {
            ...
            children: c(
              `div`,
              { className: `framer-vimeo`, ref: b, style: { width: `100%`, height: `100%` } },
              v
            ),
          })
        );
    ...
    _(Z, {
      video: { title: `URL`, type: v.String },
      ...y,
      controls: { title: `Controls`, type: v.Boolean, enabledTitle: `Show`, disabledTitle: `Hide` },
      autoplay: { title: `Autoplay`, type: v.Boolean, enabledTitle: `Yes`, disabledTitle: `No` },
      loop: { title: `Loop`, type: v.Boolean, enabledTitle: `Yes`, disabledTitle: `No` },
      mute: { title: `Mute`, type: v.Boolean, enabledTitle: `Yes`, disabledTitle: `No` },
...
//# sourceMappingURL=Vimeo.VX0Ly7ko.mjs.map
