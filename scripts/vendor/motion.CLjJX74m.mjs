...
function mn(e, t, { delay: n = 0, transitionOverride: r, type: i } = {}) {
  ...
  for (let t in s) {
    ...
    r.start(iu(t, r, i, p && au.has(t) ? { type: !1 } : o, e, f));
    let m = r.animation;
    m && u.push(m);
  }
  if (o) {
...
function Si({
  ...
  return class {
    ...
    willUpdate(e = !0) {
      ...
      if (
        (T.MotionCancelOptimisedAnimation && !this.hasCheckedOptimisedAppear && xi(this),
...
function Xi({ children: e, isPresent: t, anchorX: n, anchorY: r, root: a, pop: o }) {
  let s = C(),
    c = i(null),
    u = i({ width: 0, height: 0, top: 0, left: 0, right: 0, bottom: 0 }),
    { nonce: d } = v($),
    m = Yi(c, e.props?.ref ?? e?.ref);
  return (
    f(() => {
      let { width: e, height: i, top: l, left: f, right: p, bottom: m } = u.current;
      if (t || o === !1 || !c.current || !e || !i) return;
      let h = n === `left` ? `left: ${f}` : `right: ${p}`,
        g = r === `bottom` ? `bottom: ${m}` : `top: ${l}`;
...
function fa(e) {
  let { initial: t, animate: r } = da(e, v(mf));
...
function ba(e, t, r, { latestValues: i }, a, o = !1, s) {
  let l = ((s ?? ya(e)) ? va : _a)(t, i, a, e),
    u = sa(t, typeof e == `string`, o),
    d = e === c ? {} : { ...u, ...l, ref: r },
    { children: f } = t,
    p = n(() => (X(f) ? f.get() : f), [f]);
  return S(e, { ...d, children: p });
}
function xa(e, t, n) {
  let r = i(n);
  f(() => {
...
function Ca(e, t, n, r, a, o) {
  ...
  let _ = h.current,
    y = v(gf);
  _ && !_.projection && a && (_.type === `html` || _.type === `svg`) && wa(h.current, n, a, y);
  let b = i(!1);
  f(() => {
    _ && b.current && _.update(n, u);
  });
  let x = n[fu],
    S = i(
    ...
    Ms(() => {
      ((g.current = !0),
        _ &&
          ...
          S.current && _.animationState && _.animationState.animateChanges()));
    }),
    s(() => {
      _ &&
        (!S.current && _.animationState && _.animationState.animateChanges(),
...
function Ea(e, { forwardMotionProps: t = !1, type: n } = {}, r, i) {
  ...
  function s(n, s) {
    ...
    if (!u && T !== void 0) {
      Oa(l, r);
      let t = ka(l);
      ((c = t.MeasureLayout), (d.visualElement = Ca(e, f, l, i, t.ProjectionNode, a)));
    }
    return y(mf.Provider, {
      value: d,
      children: [
        c && d.visualElement ? p(c, { visualElement: d.visualElement, ...l }) : null,
        ba(e, n, xa(f, d.visualElement, s), f, u, t, a),
      ],
    });
  }
...
function eo(e) {
  let [t, n] = Qi(),
    r = v(As);
  return p(Bf, { ...e, layoutGroup: r, switchLayoutGroup: v(gf), isPresent: t, safeToRemove: n });
}
function to(e, t, n) {
  let { props: r } = e;
...
function Lo(e, t = {}) {
  ...
  if (n) return Po(r);
  let i = jo(r());
  return (f(() => Jn(i, e, t), [i, JSON.stringify(t)]), i);
}
function Ro(e, t = {}) {
...
function xs({ children: e, as: t = `ul`, axis: n = `y`, onReorder: r, values: a, ...o }, c) {
  let l = M(() => $f[t]),
    u = [],
    d = i(!1),
    f = i(null);
  ...
  return p(l, {
    ...
    ref: h,
    ignoreStrict: !0,
    children: p(Ap.Provider, { value: m, children: e }),
  });
}
function Ss(e, t) {
...
function ks(
  ...
  let { axis: m, registerItem: h, updateOrder: g, groupRef: _ } = u;
  return p(l, {
    drag: m,
    ...s,
    dragSnapToOrigin: !0,
    ...
    onDrag: (e, t) => {
      ...
      (g(n, d[m].get(), r[m]), Ds(_.current, a[m], m, r[m]), i && i(e, t));
    },
    onDragEnd: (e, t) => {
      (Cs(), a && a(e, t));
    },
...
var As,
  ...
  zp = t(() => {
    (o(),
      ...
      (Al = (e) => e.startsWith(`--`)),
      (jl = {}),
      (Ml = Lt(() => T.ScrollTimeline !== void 0, `scrollTimeline`)),
      (Nl = Lt(() => T.ViewTimeline !== void 0, `viewTimeline`)),
      (Pl = Lt(() => {
        try {
      ...
      (tf = ({
        ...
        return (
          ...
          p(Ns.Provider, { value: g, children: e })
        );
      }),
      (nf = (e) => e.key || ``),
      (rf = ({
        ...
        if (g !== w) {
          ...
          return (s === `wait` && E.length && (e = E), te($i(e)), ee(g), null);
        }
        let { forceRender: ne } = v(As);
        return p(x, {
          children: T.map((e) => {
            let n = nf(e),
              i = c && !m ? !1 : g === T || _.includes(n);
            return p(
              tf,
              {
                isPresent: i,
      ...
      (cf = ({ children: e, id: t, inherit: r = !0 }) => {
        ...
        return p(As.Provider, { value: d, children: e });
      }),
      (lf = a({ strict: !1 })),
      (uf = {
        animation: [
    ...
    ((mf = a({})),
      ...
      (Of = (e, t) => Math.abs(e - t)),
      (kf = (e, t) => ((t.isSVG ?? ya(e)) ? new xd(t) : new md(t, { allowProjection: e !== c }))),
      ...
      (Ff = class {
        ...
        addListeners() {
          ...
          let o = _i(T, `resize`, () => this.scalePositionWithinConstraints()),
...
//# sourceMappingURL=motion.CLjJX74m.mjs.map
