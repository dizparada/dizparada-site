  ...
  (function () {
    ...
    function Tt(e, t) {
      return (
        ...
        Object.getOwnPropertyDescriptors
          ...
          : Bi(Object(t)).forEach(function (r) {
    ...
    function Yt(e, t) {
      if (e) {
        ...
        if (
          (r === "Object" && e.constructor && (r = e.constructor.name), r === "Map" || r === "Set")
        )
          return Array.from(r);
    ...
    function Ji(e) {
      return (
        w(e, HTMLInputElement) ||
        w(e, HTMLSelectElement) ||
        w(e, HTMLTextAreaElement) ||
        w(e, HTMLButtonElement)
      );
    }
    function Vr(e) {
    ...
    function _a(e) {
      ...
      var n = Vr(r),
        a = n
          ...
          .join(""),
        u = [
          "m:".concat((t = r.getAttribute("method")) !== null && t !== void 0 ? t : ""),
          "f:".concat(n.length),
          a,
        ].join("|");
      return u;
    ...
    var Br = "c",
      ...
      no =
        ...
        te(
          ...
          Br,
          [
            2071475277, 2531075807, 2087764529, 2650702126, 897792407, 1900861264, 193440998,
            181887339,
          ]
        ),
        te(Ee, qr, [3710748438, 194507255, 2123698751, 2088097853]),
        te(Ee, Jr, [3716925445, 1236122734, 1917612522]),
        te(Ee, jr, [173246534, 1422232710, 2984385681, 2172846769]),
        te(Ee, Kr, [517084052, 3937470477]),
        te(Ee, zr, [194507792, 1354128738, 1385023551]),
        te(Ee, Gr, [2172845875, 2984384787, 2901189036, 3027005952, 2088000679]),
        te(Ee, Xr, [1759493702, 1322218894]),
        Ee);
    function Ue(e) {
      var t;
    ...
    function ao(e) {
      ...
      for (var l = new Set(), d = 0; d < t.length; d++)
        (l.add(Be(t[d])), d + 1 < t.length && l.add(Be("".concat(t[d], " ").concat(t[d + 1]))));
      return l;
    }
    function Ve(e, t) {
    ...
    function Ea(e) {
      ...
      try {
        for (var u = e.attributes[Symbol.iterator](), l; !(r = (l = u.next()).done); r = !0) {
          var d = l.value;
          [2203664931, 2087944093, 2087876002, 5861160, 247325877, 3566271494].indexOf(
            Be(d.name)
          ) !== -1 && t.push(le(d.value));
        }
      } catch (f) {
    ...
    function uo(e, t) {
      ...
      try {
        for (
          var b = re(e.querySelectorAll("label")).slice(0, ut)[Symbol.iterator](), A;
          !(E = (A = b.next()).done);
          E = !0
        ) {
          var P = A.value;
    ...
    function co(e, t, r) {
      ...
      return { pac: Ta(t, lo(e, t, r)), pad: At(Ki, ar, ir, t.length, n, a, r.length, u) };
    }
    function xa(e) {
      ...
      if (!t) {
        for (
          ...
          r.push(n);
        if (r.length === 0) return { pac: Hr, pad: At(Wr, ar, ir, 0, 0, 0, 0, "") };
        var u = r[r.length - 1],
        ...
        return f !== null ? f : { pac: Hr, pad: At(Wr, ar, ir, 0, 0, 0, 0, "") };
      }
      var I = Vr(t),
      ...
      return { pac: Ta(I, uo(t, I)), pad: At(zi, oo(t), io(t), I.length, M, C, j, U) };
    }
    function so(e) {
            ...
            if (w(d, Element)) {
              ...
              try {
                for (
                  ...
                  var P = A.value,
                    I;
                  (n == null || (I = n.shouldIgnoreAttribute) === null || I === void 0
                    ? void 0
                    : I.call(n, m, P)) !== !0 && (a += "_".concat(Ur(P.name, 2)));
                }
              } catch (M) {
                ((S = !0), (O = M));
              } finally {
    ...
    function Yr(e) {
      if (typeof e != "string")
        throw new TypeError(
          "djb2: expected string, got ".concat(typeof e == "undefined" ? "undefined" : W(e))
        );
    ...
    function Ca(e, t, r) {
      return (
        (t = Qe(t)),
        Oa(e, Ot() ? Reflect.construct(t, r || [], Qe(e).constructor) : t.apply(e, r))
      );
    }
    function ka(e, t) {
    ...
    function Da() {
      var e = Lt();
      e === void 0 &&
        x("Could not find Turnstile valid script tag, some features may not be available", 43777);
      var t = e.src,
        r;
      try {
        r = new URL(t);
      ...
      var n = { loadedAsync: !1, params: new URLSearchParams(), src: t, url: r };
    ...
    var Mt = 1,
      ...
      Fa = Symbol();
    function cr(e, t) {
      Object.defineProperty(e, Fa, { configurable: !0, enumerable: !1, value: t });
    }
    function Ha(e, t) {
    ...
    function ve(e, t) {
      return t.kills === void 0
        ? !1
        : "".concat(dr).concat(t.kills).concat(dr).includes("".concat(dr).concat(e).concat(dr));
    }
    function pt(e) {
      try {
    ...
    function Qa(e) {
      ...
      (e.style.display === "none" && t.push("dn"),
        (e.style.visibility === "hidden" || e.style.visibility === "collapse") &&
    ...
    function Io(e, t, r) {
      for (var n = e, a = 0; n && a < $a;) {
        ...
        if (
          ...
          u.rect.h > 0 &&
          !u.inViewport &&
          rn(Tt(Ce({}, u.rect), { x: u.rect.x - l[0], y: u.rect.y - l[1] }))
        )
          return mr(u, [bo]);
    ...
    var un = function (t) {
        var r,
          ...
          d =
            t.state !== tr.FailureFeedbackCode &&
            (t.state === tr.FailureFeedback ||
              t.state === tr.FailureHavingTroubles ||
              t.errorCode === void 0 ||
              t.errorCode === 0),
          f = G(
            Lo,
            (r = (a = t.displayLanguage) === null || a === void 0 ? void 0 : a.toLowerCase()) !==
              null && r !== void 0
              ? r
              : "nonexistent"
          ),
          s = G(
            Mo,
            (n = (u = t.displayLanguage) === null || u === void 0 ? void 0 : u.toLowerCase()) !==
              null && n !== void 0
              ? n
              : "nonexistent"
          );
        return l
          ? No({ isModeratelyVerbose: s, isSmallerFeedback: d, isVerboseLanguage: f })
          : d && f
            ? "680px"
            : d && s
              ? "670px"
    ...
    var si = function (t, r, n, a, u) {
      ...
      (b.append("consent", "on"),
        ...
        b.append("rayId", n),
        b.append("sitekey", (l = t.params.sitekey) !== null && l !== void 0 ? l : ""),
        b.append("rcV", (d = t.rcV) !== null && d !== void 0 ? d : ""),
        b.append("cfChlOut", (f = t.cfChlOut) !== null && f !== void 0 ? f : ""),
        b.append("cfChlOutS", (s = t.cfChlOutS) !== null && s !== void 0 ? s : ""),
        b.append("mode", (m = t.mode) !== null && m !== void 0 ? m : ""),
        b.append("errorCode", String((E = t.errorCode) !== null && E !== void 0 ? E : 0)),
        b.append("frMd", a),
        b.append("displayLanguage", (S = t.displayLanguage) !== null && S !== void 0 ? S : ""));
      try {
        if (
      ...
      try {
        return (
          fetch(O, Ce({ body: b, keepalive: !0, method: "POST", mode: "no-cors" }, ci())),
          !0
        );
      } catch (A) {
        R(
    ...
    function gi(e) {
      var t,
        r = di(
          (t = Object.getOwnPropertyDescriptor(e, cn)) === null || t === void 0 ? void 0 : t.value
        );
      if (r) return r;
      var n = !0,
        a = !1,
      ...
      try {
        for (
          ...
          var f = d.value,
            s,
            m = di(
              (s = Object.getOwnPropertyDescriptor(e, f)) === null || s === void 0
                ? void 0
                : s.value
            );
          if (m) return m;
    ...
    function Wo(e, t) {
      Object.defineProperty(e, cn, { configurable: !0, enumerable: !1, value: { cleanup: t } });
    }
    function Uo(e) {
    ...
    var dn = function (t, r, n, a, u) {
        var l,
          ...
          S = Vo(
            ""
              ...
              .concat((d = r.params.theme) !== null && d !== void 0 ? d : r.theme, "/")
              .concat(n)
          );
        if ((mt(r), window.top !== window.self)) {
          ...
          if (O) {
            ...
            var b = window.setInterval(function () {
              O.closed &&
                (window.clearInterval(b), (r.feedbackPopupCloseCheck = void 0), u == null || u());
            }, 500);
        ...
        r.wrapper.parentNode ||
          x("Cannot initialize Widget, Element not found (#".concat(t, ")."), 3074);
        var A = mi(f);
        if (A) {
          var P;
        ...
        ((k.id = f),
          ...
          k.setAttribute("sandbox", "allow-same-origin allow-scripts allow-popups allow-forms"),
        ...
        (D.setAttribute("tabindex", "0"),
          ...
          r.displayRtl === !0 ? (D.style.left = "24px") : (D.style.right = "24px"),
          (D.style.top = "24px"),
        ...
        (K.setAttribute("stroke-width", "1"),
          ...
          r.theme === er.Light
            ? (H.setAttribute("stroke", "#0A0A0A"), K.setAttribute("stroke", "#0A0A0A"))
            : (H.setAttribute("stroke", "#F2F2F2"), K.setAttribute("stroke", "#F2F2F2")),
          D.appendChild(H),
          D.appendChild(K),
          C.appendChild(k),
          C.appendChild(D),
      ...
      Ut = function (t) {
        ...
        if (a) {
          ...
          (R("Unable to find feedback overlay cleanup handler. Removing overlay without cleanup."),
        ...
        for (var u = e.widgetMap[Symbol.iterator](), l; !(r = (l = u.next()).done); r = !0) {
          ...
          if (!jo(E) || !s.wrapper.isConnected) {
            s.watchcat.missingWidgetWarning ||
              ((s.watchcat.missingWidgetWarning = !0), t.push({ widgetElId: m, widgetId: f }));
            continue;
          }
          ...
          if (
            ...
            if (
              ((s.isExecuting || !s.isInitialized || (!s.isStale && !s.isExecuted)) &&
    ...
    function fn(e) {
      return (
        (typeof e == "undefined" ? "undefined" : W(e)) === "object" &&
        e !== null &&
        "widgetMap" in e &&
        w(e.widgetMap, Map) &&
    ...
    function Go(e, t) {
      Object.defineProperty(e, pn, { configurable: !0, enumerable: !1, value: t });
    }
    function Xo(e) {
    ...
    function Yo(e) {
      return !Number.isFinite(e.apiJsReloadBackoffMs) || e.apiJsReloadBackoffMs <= 0
        ? it
        : Math.min(e.apiJsReloadBackoffMs, St);
    }
    function Qo(e) {
      return !Number.isFinite(e.apiJsReloadNextAllowedTsMs) || e.apiJsReloadNextAllowedTsMs <= 0
        ? 0
    ...
    function Ei(e, t, r) {
      ...
      ((t.isReady = a.isReady),
        ...
        (t.apiJsReloadBackoffMs = u ? it : Yo(a)),
        (t.apiJsReloadNextAllowedTsMs = Qo(a)),
    ...
    function wn(e) {
      ...
      if (
        (e.params["offlabel-show-privacy"] !== void 0 &&
          t.set("offlabel_show_privacy", String(e.params["offlabel-show-privacy"])),
    ...
    function wi() {
      for (
        var e = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : window, t = e;
    ...
    function Ni() {
      ...
      try {
        for (
          var n = y.widgetMap.values()[Symbol.iterator](), a;
          !(e = (a = n.next()).done);
          e = !0
        ) {
          var u = a.value;
    ...
    function Nn() {
      var e = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {},
        ...
        r = t === void 0 ? !1 : t;
      ((Or = void 0),
        r || (y.apiJsMismatchReloadPending = !1),
    ...
    function fu(e) {
      (Nn({ preserveMismatchReloadPending: !0 }),
        (y.apiJsMismatchReloadPending = !0),
        (Or = e),
    ...
    function Di(e, t) {
      var r,
        ...
        d =
          (!n || w(document.querySelector("#".concat(u)), HTMLInputElement)) &&
          (!a || w(document.querySelector("#".concat(l)), HTMLInputElement));
      if (!(e.responseElementsBuilt && d)) {
        if (n && !w(document.querySelector("#".concat(u)), HTMLInputElement)) {
          var f,
            s = document.createElement("input");
          ((s.type = "hidden"),
            (s.name = (f = e.params["response-field-name"]) !== null && f !== void 0 ? f : ea),
            (s.id = u),
    ...
    function br(e, t) {
      var r,
        n = (r = t.params.size) !== null && r !== void 0 ? r : ne.Normal,
        a = t.mode;
      switch (a) {
            ...
            case ne.Invisible:
              x(
                'Invalid value for parameter "size", expected "'
                  .concat(ne.Compact, '", "')
                  .concat(ne.Flexible, '", or "')
                  .concat(ne.Normal, '", got "')
                  .concat(n, '"'),
                2817
              );
            case ne.Normal:
        ...
        default:
          x(
            'Invalid value for parameter "mode", expected "'
              .concat(de.NonInteractive, '", "')
              .concat(de.Managed, '" or "')
              .concat(de.Invisible, '", got "')
              .concat(String(a), '"'),
            2818
          );
      }
    ...
    function yu(e) {
      var t, r;
      return ((r = e.feedbackPopup) === null || r === void 0 ? void 0 : r.closed) === !0
    ...
    function Ar(e, t) {
      var r,
        n,
        a =
          (r = (n = gu(e, t)) === null || n === void 0 ? void 0 : n.contentWindow) !== null &&
          r !== void 0
            ? r
            : null;
      if (a !== null) return { targetOrigin: e.feedbackIframeOrigin, targetWindow: a };
      var u = yu(e);
      return { targetOrigin: u === null ? void 0 : e.feedbackPopupOrigin, targetWindow: u };
    }
    function hu(e) {
    ...
    function Eu(e, t, r) {
      var n,
        a,
        u =
          (n = (a = De(t, r)) === null || a === void 0 ? void 0 : a.contentWindow) !== null &&
          n !== void 0
            ? n
            : null,
    ...
    function Tu() {
      try {
        ...
        try {
          for (
            var u = performance.getEntriesByType("resource")[Symbol.iterator](), l;
            !(r = (l = u.next()).done);
            r = !0
          ) {
            var d = l.value;
    ...
    var Hi = (function () {
        ...
        function l(c) {
          ...
          if (!(
            ...
            ve("feedback-report-auto-submit", c)
          )) {
            ...
            return Yn(this, function (fe) {
              switch (fe.label) {
                case 0:
                  ...
                  ((F = Pt(c, "g")),
                    (z = F === void 0 ? "" : "h/".concat(encodeURIComponent(F), "/")),
                    (q = new URL(N)),
                    (ge = "https"),
                    (He = ""),
                    (se = ""
                ...
                case 3:
                  return (
                    (ye = fe.sent()),
                    L(!1, "Error contacting Turnstile, aborting clearance redemption."),
                    [3, 4]
                  );
                case 4:
                  return [2];
        ...
        function s(c, i, v) {
          if (c.params.retry === rr.Auto || v) {
            ...
            var p = v
              ? 0
              : 1e3 * 2 + ((h = c.params["retry-interval"]) !== null && h !== void 0 ? h : 0);
        ...
        function m(c, i, v) {
          return c.params.execution === wt.Render
            ? !0
            : (i === ae.CrashedRetry ||
                i === ae.FailureRetry ||
                i === ae.CheckDelays ||
                i === ae.UpgradeReload) &&
                c.params.execution === wt.Execute &&
                v;
        }
        function E(c, i, v) {
          if (
            ...
            c.feedbackPopupCloseCheck !== void 0 &&
              ...
              (c.feedbackPopupCloseCheck = void 0)),
            pi(),
            window.postMessage({ event: "feedbackClose", source: J, widgetId: v }, "*"),
            c.pendingRetry)
          ) {
        ...
        function S(c, i, v) {
          var h;
          (c.response === void 0 &&
            x("[Internal Error] Widget was completed but no response was given", 1362),
            (c.isExecuting = !1),
            (c.isComplete = !0),
            Fi(c, i, c.response),
            (h = c.cbSuccess) === null || h === void 0 || h.call(c, c.response, v));
        }
        function O(c) {
          if (!c) return [];
          for (var i = c.attributes, v = i.length, h = new Array(v), p = 0; p < v; p++)
            h[p] = i[p].name;
          return h;
        }
        function b() {
            ...
            if (v === J) {
              ...
              if (!(typeof h != "string" || h === "" || !y.widgetMap.has(h))) {
                ...
                if (o !== void 0)
                  switch (i.event) {
                    case "init": {
                      ((o.widgetInitStartTimeTsMs = Q()),
                        (o.kills = i.kills),
                        sr(o) && (o.gcs.length = 0));
                      var g = De(o, p);
                      (g ||
                        x("Cannot initialize Widget, Element not found (#".concat(p, ")."), 3074),
                        (o.mode = i.mode),
                        (o.nextRcV = i.nextRcV),
                        o.mode === de.Invisible &&
                          o.params["refresh-expired"] === ot.Manual &&
                          R(
                        ...
                        o.mode !== de.Managed &&
                          o.params["refresh-timeout"] !== It.Auto &&
                          R(
                            "setting refresh-timeout has no effect on an invisible/non-interactive widget and will be ignored."
                          ),
                        o.params.appearance === ue.Always ||
                        (o.isExecuting && o.params.appearance === ue.Execute)
                          ? br(g, o)
                          : On(g, o),
                        oi(o, g));
                      var L = De(o, p);
                      (L || x("Received state for an unknown widget: ".concat(i.widgetId), 3078),
                        me(L, { event: "init", source: J, widgetId: i.widgetId }, o.iframeOrigin));
                      break;
                    }
                    case "translationInit": {
                    ...
                    case "languageUnsupported": {
                      (R(
                        "Language "
                          .concat(o.params.language, " is not supported, falling back to: ")
                          .concat(i.fallback, ".")
                      ),
                    ...
                    case "reject": {
                      ...
                      ((o.isExecuting = !1),
                        w(F, HTMLElement) ||
                          x(
                            "Cannot initialize Widget, Element not found (#".concat(p, ")."),
                            3075
                          ));
                    ...
                    case "complete": {
                      ...
                      if (
                        ...
                        !ve("scs", o) &&
                        ((o.scs = i.scs),
                        o.params["session-continuity-persist"] === !0 && !ve("scs_persist", o))
                      ) {
                    ...
                    case "fail": {
                      ...
                      if (
                        ...
                        i.cfChlOut !== void 0 && i.cfChlOut !== "" && (o.cfChlOut = i.cfChlOut),
                        i.cfChlOutS !== void 0 && i.cfChlOutS !== "" && (o.cfChlOutS = i.cfChlOutS),
                        i.code !== void 0 && i.code !== 0 && (o.errorCode = i.code),
                        i.aC !== void 0 && i.aC !== "")
                      ) {
                        var ye;
                      ...
                      if (Ie) {
                        ...
                        we &&
                          me(
                            we,
                            { event: "forceFail", source: J, widgetId: i.widgetId },
                            o.iframeOrigin
                          );
                      }
                      if (fe !== void 0) {
                        var Z;
                        fe(String((Z = i.code) !== null && Z !== void 0 ? Z : ca)) === !0
                          ? $ && o.params.retry === rr.Auto && !o.isResetting && s(o, p, Ie)
                          : (i.code !== void 0 && i.code !== 0 && R("Error: ".concat(i.code, ".")),
                            $ && s(o, p, Ie));
                      } else
                        i.code !== void 0 && i.code !== 0
                          ? ($ && s(o, p, Ie), x("Error: ".concat(i.code), 3076))
                          : s(o, p, !1);
                      break;
                    }
                    case "feedbackInit": {
                      ...
                      if (
                        (o.autoFeedbackSent !== !0 && !ve("feedback-report-auto-submit", o)
                          ? t.set(o, { feedbackOrigin: i.feedbackOrigin, rayId: i.rayId })
                          : t.delete(o),
                        (o.feedbackOpen = !0),
                        ...
                        (clearTimeout(o.retryTimeout),
                          (o.retryTimeout = void 0),
                          ((rt = (yt = o).pendingRetry) !== null && rt !== void 0) ||
                            (yt.pendingRetry = { crashed: !1 }));
                      }
                      (fi(),
                        window.postMessage(
                          { event: "feedbackOpen", source: J, widgetId: i.widgetId },
                          "*"
                        ),
                    ...
                    case "requestFeedbackData": {
                      ...
                      (w(T, HTMLElement) ||
                        ...
                        me(
                          T,
                          { event: "requestTurnstileResults", source: J, widgetId: i.widgetId },
                          o.iframeOrigin
                        ),
                        l(o));
                      break;
                    ...
                    case "turnstileResults": {
                      ...
                      $r(
                        jt,
                        {
                          ...
                          cfChlOutS:
                            (Ge = o.cfChlOutS) !== null && Ge !== void 0 ? Ge : i.cfChlOutS,
                    ...
                    case "closeFeedbackReportIframe": {
                      ...
                      (kr || x("Received state for an unknown widget: ".concat(i.widgetId), 3078),
                        Ut("".concat(p, "-fr")),
                        mt(o),
                        E(o, p, i.widgetId));
                      break;
                    ...
                    case "tokenExpired": {
                      var _t,
                        Lr = i.token;
                      ((o.isExpired = !0),
                        (_t = o.cbExpired) === null || _t === void 0 || _t.call(o, Lr),
                        o.params["refresh-expired"] === ot.Auto &&
                          !o.isResetting &&
                          H(ae.AutoExpire, p));
                      break;
                    }
                    case "interactiveTimeout": {
                      ...
                      if (
                        (Kt
                          ? Kt()
                          : o.params["refresh-timeout"] === It.Never &&
                            !o.isResetting &&
                            R(
                        ...
                        o.params["refresh-timeout"] === It.Auto && !o.isResetting)
                      ) {
                    ...
                    case "reloadApiJsRequest": {
                      ...
                      Wi()
                        ? (y.apiJsMismatchReloadAttempts++, su(), fu(i.widgetId))
                        : qt(i.widgetId);
                      break;
                    }
                    case "interactiveBegin": {
                      ...
                      (w(We, HTMLElement) ||
                        x("Cannot layout widget, Element not found (#".concat(p, ")."), 3076),
                        (Oe = o.cbBeforeInteractive) === null || Oe === void 0 || Oe.call(o),
                        o.params.appearance === ue.InteractionOnly && br(We, o));
                      break;
                    }
                    case "interactiveEnd": {
                      var oe;
                    ...
                    case "requestExtraParams": {
                      ...
                      var Xe = De(o, p);
                      (Xe || x("Received state for an unknown widget: ".concat(i.widgetId), 3078),
                        (o.isResetting = !1));
                      var zt = {},
                        Gt = Q(),
                        ee = ii(o, Xe),
                      ...
                      if (
                        ...
                        if (nt !== null && nt !== "") {
                          ...
                          try {
                            var Ye;
                            pe =
                              (Ye = localStorage.getItem(Mr)) !== null && Ye !== void 0
                                ? Ye
                                : void 0;
                          } catch (_e) {}
                        }
                      }
                      (pe !== void 0 && pe !== "" && pe.length > pa && (pe = void 0),
                        me(
                          Xe,
                          Ce(
                            {
                              ...
                              apiJsMismatchReloadCompletedCount:
                                y.apiJsMismatchReloadCompletedCount,
        ...
        function j(c, i, v) {
          for (; c.msgQueue.length > 0;) {
            ...
            me(
              v,
              { cs: h === Rt.Execute ? Ht(c) : void 0, event: h, source: J, widgetId: i },
              c.iframeOrigin
            );
          }
        }
          ...
          if (i) {
            ...
            (h.length > 0 &&
              ...
              i.action !== void 0 &&
                ...
                (hn(i.action) ||
                  x(
                    'Invalid input for optional parameter "action", got "'.concat(i.action, '"'),
                    3604
                  ),
                (c.action = i.action)),
              i.cData !== void 0 &&
                ...
                (_n(i.cData) ||
                  x(
                    'Invalid input for optional parameter "cData", got "'.concat(i.cData, '"'),
                    3605
                  ),
                (c.cData = i.cData)),
              ...
              i["error-callback"] !== void 0 && (c.cbError = Qr(i["error-callback"])),
              i["unsupported-callback"] !== void 0 && (c.cbUnsupported = i["unsupported-callback"]),
              i.chlPageData !== void 0 && i.chlPageData !== "" && (c.chlPageData = i.chlPageData));
          }
        }
        function D(c, i, v) {
        ...
        function H(c, i, v) {
          ...
          ((g.isResetting = !0),
            ...
            (g.watchcat.seq = 0),
            m(g, c, L) && (g.msgQueue.push(Rt.Execute), (g.isExecuted = !0), (g.isExecuting = !0)));
          var _ = Y(o),
            N = De(g, _);
          (N === null && x("Widget ".concat(o, " to reset was not found."), 3330),
            (g.params.appearance === ue.InteractionOnly || g.params.appearance === ue.Execute) &&
              On(N, g),
            g.params.sitekey === null && x("Unexpected Error: Sitekey is null", 3347));
          var F = N.cloneNode();
        ...
        function xe(c, i, v, h) {
          ...
          if (typeof c == "string") {
            ...
            if (ye === null) {
              ...
              (fe === null && x('Unable to find a container for "'.concat(c, '"'), 3585),
                (se = fe));
            } else {
              var Ie,
                $ = y.widgetMap.get(ye),
                we =
                  (Ie = $ == null ? void 0 : $.wrapper.parentElement) !== null && Ie !== void 0
                    ? Ie
                    : null;
              if (we !== null && Ci(v, $)) ((se = we), (ce = { widget: $, widgetId: ye }));
          ...
          if (rt !== void 0) {
            var T = Object.assign(rt, i),
              ...
              ht = T.chlPageData,
              Ae = T.sitekey;
            ((T.theme = (p = T.theme) !== null && p !== void 0 ? p : er.Auto),
              (T.retry = (o = T.retry) !== null && o !== void 0 ? o : rr.Auto),
              (T.execution = (g = T.execution) !== null && g !== void 0 ? g : wt.Render),
              (T.appearance = (L = T.appearance) !== null && L !== void 0 ? L : ue.Always),
              (T["retry-interval"] = Ri(T["retry-interval"], na)),
              (T["expiry-interval"] = Ri(T["expiry-interval"], (ia - oa) * 1e3)),
              (T.size = (_ = T.size) !== null && _ !== void 0 ? _ : ne.Normal));
            var Cr = T.callback,
            ...
            (typeof Ae != "string" &&
              x(
                'Invalid or missing type for parameter "sitekey", expected "string", got "'.concat(
                  typeof Ae == "undefined" ? "undefined" : W(Ae),
                  '"'
                ),
                3588
              ),
              Ti(Ae) || x('Invalid input for parameter "sitekey", got "'.concat(Ae, '"'), 3589),
              bn(T.size) ||
                x(
              ...
              (T.language === void 0 || T.language === "") && (T.language = "auto"),
              xn(T.language) ||
                (R(
            ...
            En(Oe)
              ...
              : x(
                  'Invalid type for parameter "refresh-expired", expected never|manual|auto, got "'
                    .concat(String(Oe), '" ')
                    .concat(typeof Oe == "undefined" ? "undefined" : W(Oe)),
                  3603
                );
            ...
            (Tn(We)
              ...
              : x(
                  'Invalid type for parameter "refresh-timeout", expected never|manual|auto, got "'
                    .concat(String(We), '" ')
                    .concat(typeof We == "undefined" ? "undefined" : W(We)),
                  3603
                ),
              hn(ze) ||
                x('Invalid input for optional parameter "action", got "'.concat(ze, '"'), 3604),
              _n(Ge) ||
                x('Invalid input for optional parameter "cData", got "'.concat(Ge, '"'), 3605));
            ...
            return (
              ...
              oe.setAttribute("sandbox", "allow-same-origin allow-scripts allow-popups"),
              (oe.id = he),
              ...
              vr(be),
              Di(be, he),
              ce && K(ce.widgetId, ce.widget),
              se.appendChild(Xe),
              (be.widgetRenderEndTimeTsMs = Q()),
              he
            );
          }
        }
          ...
          Fn = Tt(Ce({}, tt), {
            ...
            execute: function (i, v) {
              ...
              if (o === null) {
                var g;
                v === void 0 &&
                  x("Please provide 2 parameters to execute: container and parameters", 43521);
                var L = xe(i, v, "explicit", h);
                ((p = !0),
                  L == null && x("Failed to render widget", 43522),
                  (o = (g = kt(L)) !== null && g !== void 0 ? g : C(i)),
              ...
              if (_ !== void 0) {
                ...
                if (((_.isExecuting = !0), _.response !== void 0 && _.response !== "")) {
                  ...
                  ((_.isExecuting = !1),
                    ...
                    N && fr(o, _),
                    (z = _.cbSuccess) === null || z === void 0 || z.call(_, _.response, !1));
                  return;
                }
                (_.isExpired &&
                  R(
                  ...
                  _.isStale && (H(ae.StaleExecute, F), (_.isExecuting = !0)),
                  (_.isResetting || !_.isInitialized) && _.msgQueue.push(Rt.Execute),
                  (_.isExecuted = !0));
                var q = De(_, F);
                if (
                  (q ||
                ...
                (_.params.appearance === ue.Execute && br(q, _),
                  U(_) &&
                    me(q, { cs: Ht(_), event: "execute", source: J, widgetId: o }, _.iframeOrigin));
              }
            },
            ...
            isExpired: function (i) {
              ...
              if (typeof i == "undefined") {
                ...
                if (p !== void 0) {
                  ...
                  return (
                    g !== void 0 && Ke(p, g, h),
                    (o = g == null ? void 0 : g.isExpired) !== null && o !== void 0 ? o : !1
                  );
                }
                x("Could not find a widget", 43794);
              }
              ...
              return (
                _ && Ke(L, _, h),
                (v = _ == null ? void 0 : _.isExpired) !== null && v !== void 0 ? v : !1
              );
            },
            ready: function (i) {
                ...
                typeof i != "function" &&
                  x(
                    'turnstile.ready() expected a "function" argument, got "'.concat(
                      typeof i == "undefined" ? "undefined" : W(i),
                      '"'
                    ),
                    3841
                  ));
              ...
              try {
                for (
                  var g = y.widgetMap[Symbol.iterator](), L;
                  !(h = (L = g.next()).done);
                  h = !0
                ) {
                  var _ = at(L.value, 2),
    ...
    function Su(e) {
      ...
      l !== null &&
        l !== "" &&
        (vn(l) ? (a.theme = l) : R('Unknown data-theme value: "'.concat(l, '".')));
      var d = e.getAttribute("data-size");
      if (
        (d !== null &&
          d !== "" &&
          (bn(d) ? (a.size = d) : R('Unknown data-size value: "'.concat(d, '".'))),
        0)
      )
        var f;
      ...
      E !== null &&
        ...
        (mn(E)
          ? (a.retry = E)
          : R('Invalid data-retry value: "'.concat(E, ", expected either 'never' or 'auto'\".")));
      ...
      function C(B) {
        ...
        if (!(xe === null || xe === "")) {
          ...
          return Se === void 0
            ? void 0
            : function () {
                for (var et = arguments.length, Fe = new Array(et), tt = 0; tt < et; tt++)
                  Fe[tt] = arguments[tt];
    ...
    ((Ze = !1),
      (V = Da()),
      (y.scriptWasLoadedAsync =
        (xr = V == null ? void 0 : V.loadedAsync) !== null && xr !== void 0 ? xr : !1),
      (y.scriptUrl =
        (Sr = V == null ? void 0 : V.src) !== null && Sr !== void 0 ? Sr : "undefined"),
      (y.scriptUrlParsed = V == null ? void 0 : V.url),
      uu(),
      (V == null ? void 0 : V.params) !== void 0 &&
        ...
        (gt == null ? void 0 : gt.toLowerCase()) === "recaptcha"
          ? typeof window.grecaptcha == "undefined"
            ? (R("Compatibility layer enabled."),
              (y.isRecaptchaCompatibilityMode = !0),
              (window.grecaptcha = Tr))
            : R("grecaptcha is already defined. The compatibility layer will not be enabled.")
          : gt !== null && R('Unknown value for api.js?compat: "'.concat(gt, '", ignoring.')),
        V.params.forEach(function (e, t) {
          G(["onload", "compat", "_cb", "_upgrade", "_reload", "render"], t) ||
            R('Unknown parameter passed to api.js: "?'.concat(t, '=...", ignoring.'));
        }),
            ...
            e === void 0
              ? (R(
                  "Unable to find onload callback '"
                    .concat(Pe, "' immediately after loading, expected 'function', got '")
                    .concat(W(kn(Pe)), "'.")
                ),
                setTimeout(function () {
                  var t = Ln(Pe);
                  t === void 0
                    ? R(
                        "Unable to find onload callback '"
                          .concat(Pe, "' after 1 second, expected 'function', got '")
                          .concat(W(kn(Pe)), "'.")
                      )
                    : t();
                }, 1e3))
      ...
      (Te = Bt ? Oi(window.turnstile) : void 0),
      (Ir =
        Bt && Ze
          ? Ei(window.turnstile, y, function () {
              var e;
              ((window.turnstile = Tr),
                (e = Oi(Tr)) === null || e === void 0 || e.reloadAfterUpgrade(),
                sn(y));
            })
          : !1),
      Ir && (Te == null || Te.clearPendingApiJsReloadRequest()),
      Bt && Ze && !Ir
        ? (R("Turnstile upgrade state was missing. Keeping the existing Turnstile instance."),
          Te == null || Te.rejectPendingApiJsReloadRequest(),
          Te == null || Te.rearmTimedUpgrade())
        : Bt && !Ze
          ? R("Turnstile already has been loaded. Was Turnstile imported multiple times?")
          : (Ir || (window.turnstile = Tr),
            Ze ||
              ((V == null || (wr = V.params) === null || wr === void 0
                ? void 0
                : wr.get("render")) !== "explicit" && Dn.push(xu),
              document.readyState === "complete" || document.readyState === "interactive"
                ? setTimeout(ki, 0)
                : window.addEventListener("DOMContentLoaded", ki)),
            Pn()));
