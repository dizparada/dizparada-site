...
import { C as t, L as n, N as r, c as i, f as a, o, u as s, z as c } from "./react.BUXbFMJS.mjs";
import { S as l } from "./motion.CLjJX74m.mjs";
import { S as u, Y as d, Z as ee, g as te, k as ne, r as re, s as f } from "./framer.BQfDiYYl.mjs";
function p(e) {
      ...
      switch (n[0]) {
        ...
        case 3: {
          ...
          return (
            ...
            nt(s) && s.preload(),
            i(re, { componentIdentifier: r, children: (e) => i(s, { ...e, ...a }) })
          );
        }
        case 4: {
          let [, e, r, ...i] = n,
...
var q,
  ...
  Pt = e(() => {
    (d(),
      tt(),
      st(),
      (ct = ee(() => import("./YouTube.CNrnhtc7.mjs"), `Youtube`, `2oueshnq6x52n`)),
      (J = {
        aOlrsPh6T: { isNullable: !0, type: f.Link },
        createdAt: { isNullable: !0, type: f.Date },
        dKH75txM2: { isNullable: !0, type: f.String },
        G_atTEKXu: { isNullable: !0, type: f.ResponsiveImage },
        hxeIG_4uH: {
          definition: {
            definitions: {
              CAnXVWPwz: { isNullable: !0, type: f.ResponsiveImage },
        ...
        id: { isNullable: !1, type: f.String },
        jbsVH2ci3: { isNullable: !0, type: f.String },
        nextItemId: { isNullable: !0, type: f.String },
        previousItemId: { isNullable: !0, type: f.String },
        Q9KRw37qd: { isNullable: !0, type: f.RichText },
        qzrywvHlm: { isNullable: !0, type: f.String },
        rQtvzklkn: {
          definition: {
            definitions: {
              CAnXVWPwz: { isNullable: !0, type: f.ResponsiveImage },
        ...
        RrL9MZUlt: { isNullable: !0, type: f.String },
        updatedAt: { isNullable: !0, type: f.Date },
        UQ200SfMv: { isNullable: !0, type: f.String },
        yRiIrgdEC: { isNullable: !0, type: f.String },
        YrW9AQ56G: { isNullable: !0, type: f.RichText },
        z8zuFR79K: { isNullable: !0, type: f.String },
        zlkT3LaAb: { isNullable: !0, type: f.Color },
      }),
      (lt = [`id`]),
      (Y = { type: 1 }),
      (ut = [`previousItemId`]),
      ...
      (kt = it({ "module:NEd4VmDdsxM3StIUbddO/4sbLnuatuUfmOTwFGSJM/YouTube.js:Youtube": ct })),
      (Q = new u()),
      ($ = {
        collectionByLocaleId: {
          default: new et({
            chunks: [
              new URL(
                `./yR6ljnT0S-chunk-default-0.framercms`,
                `https://framerusercontent.com/modules/bld74qQH67eQCBOXcJub/Hdhdm3smB46DfhckJtiE/yR6ljnT0S.js`
              ).href.replace(`/modules/`, `/cms/`),
            ],
            id: `78cd3c0c-5b13-4a82-96cf-c465f5ea49a5default`,
            indexes: [
              new G({
                collation: Y,
                collectionSchema: J,
                ...
                range: { from: 0, to: 241 },
                url: new URL(
                  `./yR6ljnT0S-indexes-default-0.framercms`,
                  `https://framerusercontent.com/modules/bld74qQH67eQCBOXcJub/Hdhdm3smB46DfhckJtiE/yR6ljnT0S.js`
                ).href.replace(`/modules/`, `/cms/`),
              }),
              new G({
        ...
        displayName: `Work`,
        id: `78cd3c0c-5b13-4a82-96cf-c465f5ea49a5`,
      }),
      (At = $),
      ne($, {
        dKH75txM2: { defaultValue: ``, title: `Project title`, type: f.String },
        zlkT3LaAb: {
          defaultValue: `rgb(0, 153, 255)`,
          title: `Preview image color`,
          type: f.Color,
        },
        G_atTEKXu: { title: `Preview Image`, type: f.ResponsiveImage },
        UQ200SfMv: { preventLocalization: !1, title: `Slug`, type: f.String },
        RrL9MZUlt: { defaultValue: ``, displayTextArea: !0, title: `Overview`, type: f.String },
        z8zuFR79K: { defaultValue: ``, title: `Category`, type: f.String },
        yRiIrgdEC: { defaultValue: ``, title: `Client`, type: f.String },
        qzrywvHlm: { defaultValue: ``, title: `Year`, type: f.String },
        jbsVH2ci3: { defaultValue: ``, title: `Preview Button text`, type: f.String },
        aOlrsPh6T: { title: `Preview Link`, type: f.Link },
        YrW9AQ56G: { defaultValue: ``, title: `Details 1`, type: f.RichText },
        rQtvzklkn: {
          __vekterDefault: [],
          control: {
            controls: { CAnXVWPwz: { title: `Image`, type: `responsiveimage` } },
            type: `object`,
          },
          title: `Gallery 1`,
          type: f.Array,
        },
        Q9KRw37qd: { defaultValue: ``, title: `Details 2`, type: f.RichText },
        hxeIG_4uH: {
          __vekterDefault: [],
          control: {
            controls: { CAnXVWPwz: { title: `Image`, type: `responsiveimage` } },
        ...
        previousItemId: {
          dataIdentifier: `local-module:collection/yR6ljnT0S:default`,
          title: `Previous`,
          ...
          let [n] = await Q.query(
            {
              ...
              select: [{ name: `UQ200SfMv`, type: `Identifier` }],
              where: {
          ...
          let [n] = await Q.query(
            {
              ...
              where: {
                left: { name: `UQ200SfMv`, type: `Identifier` },
                operator: `==`,
                right: { type: `LiteralValue`, value: e },
                type: `BinaryOperation`,
              },
...
export { At as a, Mt as i, jt as n, Pt as r, Nt as t };
//# sourceMappingURL=yR6ljnT0S.BQABhoK5.mjs.map
